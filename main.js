...
function myFunction() {
    ...
    switch(Math.floor(Math.random() * 16)){
		...
		break;
    	case 2 :
        quote = "My pain may be the reason for somebody's laugh.But my laugh must never be the reason for somebody's pain. <br><blockquote>Charlie chaplin</blockquote>";
		break;
	case 3 :
        quote = "'Empty pockets' teaches you a million things in life,but 'Full pockets' spoils you in a million ways.";
		break;
	case 4 :
        quote = "To handle yourself, use your head; to handle others, use your heart.<br> <blockquote> Eleanor Roosevelt</blockquote>";
		break;
	case 5 :
		...
		break;
	case 6 :
        quote = "Never work about numbers.Help one person at a time,and always start with the person nearest you.<br><blockquote>Mother Teresa</blockquote>";
		 break;
	case 7 :
        quote = "All of us do not have equal talent. But , all of us have an equal opportunity to develop our talents.<br><blockquote>A.P.J Abdul Kalam</blockquote> ";
		 break;
	case 8 :
        quote = "When you have money in hand,only you forget who are you. But when you do not have any money in your hand,the whole world forget who you are. Its LIFE....!<br><blockquote>Bill gates</blockquote>";
		 break;
	case 9 :
        quote = "Strength does not come from winning.Your struggles develop your strengths.When you go through hardships and decide not to surrender,that is strength-Mahatma Gandhi";
		 break;
	case 10 :
        quote = "All Birds find shelter during a rain. But Eagle avoids rain by flying above the Clouds.<br><blockquote> A.P.J Abdul Kalam</blockquote>";
		 break;
	case 11 :
        quote = "Your aim is yours So dont change it for others but Your character is not yours so change it for others.<br><blockquote>Swamy Vivekananda</blockquote>";
		 break;
	case 12 :
        quote = "When people throw stones at you,you turn them into milestones.<br><blockquote>Sachin Tendulkar</blockquote>";
		 break;
	case 13 :
        quote = "Like me or Hate me,both are in my favour,If you like me I am in your Heart,If you hate me I am in your mind.<br><blockquote> Swami Vivekananda</blockquote>";
		 break;
	case 14 :
        quote = "Talk to yourself atleast once in a Day… Otherwise you may miss a meeting with an EXCELLENT person in this World.<br><blockquote>Swami Vivekananda</blockquote>";
		 break;
	case 15 :
        quote = "I can do things you cannot,You can do things I cannot;Together we can do Great things.<br><blockquote>Mother teresa</blockquote>";
		 break;
    }
...
function myStory() {
	...
	break;
    case 2 :
	story ="<b><u>Shakespeare</u></b> <br><br>Shakespeare's Mother Said to him: You are very weak in English if you fail this time.I will not let you continue your studies.Shakespeare did not pass M.A.English.But now no one can pass M.A.English without reading Shakespeare.'Dont try to achieve the higher degrees but always try to achieve higher knowledge'.";
	break;
    case 3 : 
